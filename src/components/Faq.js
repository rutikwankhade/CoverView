        ...
        <div className="flex flex-wrap justify-center mt-20 font-Inter">
          <div className="md:w-5/12 m-4 ">
            ...
            <p className="text-lg text-gray-700">
              Coverview is a tool to create cover images for your blogs quickly
              and easily.
            </p>
          </div>
          ...
          <div className="md:w-5/12 m-4">
            ...
            <p className="text-lg text-gray-700">
              Yes.Just search and select{" "}
              <span className="font-semibold">custom</span> in icon section and
              you can upload your own logo to personalize your cover images.
            </p>
          ...
          <div className="md:w-5/12 m-4">
            ...
            <p className="text-lg text-gray-700">
              Yes! Why not? Even though coverview was built with technical blogs
              in mind, you can still use it for your personal blogs. Check out
              the stylish theme for more.
            </p>
          </div>
          ...
          <div className="md:w-5/12 m-4">
            ...
            <p className="text-lg text-gray-700">
              If coverview adds value in your life and you wish to support this
              project, you can{" "}
              <a
        ...
        {showMsg ? (
          <div>
            <h2 className="md:w-7/12 text-4xl border text-center mx-auto my-10 p-10 rounded-xl shadow-sm font-Nunito">
              Blog titles with a minimum of 8 words have 21% better
              click-through
            </h2>
          </div>
        ) : (
