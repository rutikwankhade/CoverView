    ...
    <div className="">
      <div className="">
        ...
        <div className="  mx-auto md:px-20 py-6   flex flex-col items-center">
          ...
          >
            <span className="md:text-2xl font-semibold text-lg">
              Create Now
            </span>
          </Link>
        </div>
      ...
      <div className="md:mt-32  my-t0 mx-auto">
          ...
          <div className="flex md:flex-row flex-col justify-center md:gap-6 gap-2 mx-auto">
            <div className=" p-10  rounded-xl  shadow-gray-100 flex flex-col gap-4 md:w-4/12 ">
              ...
              <p className="md:text-2xl text-xl md:text-left text-center font-Nunito ">
                Around <span className="font-bold">7 million</span> blog posts
                are published daily. And with the rise of new-age blogging
                tools, it will only go up.
              </p>
            </div>
            ...
            <div className="p-10  rounded-xl  shadow-gray-100 flex  flex-col gap-4  md:w-4/12 ">
              ...
              <p className="md:text-2xl text-xl md:text-left text-center font-Nunito ">
                A good cover image can lead to{" "}
                <span className="font-bold">higher conversion rate</span> than a
                random stock image.
              </p>
            </div>
          </div>
        ...
        <h2 className="md:text-5xl text-3xl md:w-7/12 md:mx-auto mt-12 md:mt-32 mx-10 font-bold font-Anek text-center text-gray-700">
          With coverview, you can create cover images in{" "}
        ...
        <div className="md:w-8/12 md:my-16 p-4 flex md:flex-row flex-col gap-4 mx-auto">
          <div className="md:w-1/2 md:border border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
            <div className="text-center">
              <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">
                Step 1
              </div>
            ...
            <img
              src={step1}
              alt="preview"
              className="mt-2 w-10/12 mx-auto rounded-t-xl shadow-sm"
            />
          </div>
          ...
          <div className="md:w-1/2 md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
            ...
            <img
              src={step2}
              alt="preview"
              className="mt-auto mb-0 w-10/12 mx-auto rounded-t-xl shadow-sm"
            />
          </div>
        </div>
        ...
        <div className="md:w-6/12 md:my-20 mb-6 mx-auto">
          <div className="text-center m-6 px-6">
            <p className="md:text-2xl text-xl my-2 font-semibold font-Inter text-gray-700">
        ...
        <div className="bg-gray-800  text-white p-2">
          <div className="md:w-8/12 mx-auto pt-32 p-6">
            ...
            <p className="md:text-2xl text-lg font-Inter text-gray-300 text-center py-4 md:w-8/12 mx-auto">
              So you can focus on writing your blog and never worry about those
              cover images.
            </p>
            <Link to="/editor">
