            ...
            <div className="">
                <div className="  mx-auto md:px-20 py-6   flex flex-col items-center">
                    ...
                    <Link to="/editor" className="hover:translate-x-2 duration-300 bg-gray-700 hover:bg-gray-800 group rounded-full border-4 border-gray-100 px-6 md:px-8 text-white md:text-2xl text-base mx-auto font-Poppins font-semibold md:p-4 p-2">
                        <span className="md:text-2xl font-semibold text-lg">{t('createNow')}</span>
                    </Link>
                </div>
            ...
            <div className="md:mt-32  my-t0 mx-auto">
                <div className=" mx-auto flex flex-col md:w-10/12">
                    <div className="w-full text-center mx-auto p-10 md:p-4 ">
                        <h2 className="md:text-5xl md:w-9/12 mx-auto text-3xl px-4 font-bold font-Anek text-gray-700">{t('whyCoverImagesTitle')}</h2>
                    </div>
                    ...
                    <div className="flex md:flex-row flex-col justify-center md:gap-6 gap-2 mx-auto">
                        <div className=" p-10  rounded-xl  shadow-gray-100 flex flex-col gap-4 md:w-4/12 ">
                            ...
                            <p className="md:text-2xl text-xl md:text-left text-center font-Nunito " dangerouslySetInnerHTML={createMarkup(t('blogPostsCount'))}></p>
                        </div>
                        ...
                        <div className="p-10  rounded-xl  shadow-gray-100 flex  flex-col gap-4  md:w-4/12 ">
                            ...
                            <p className="md:text-2xl text-xl md:text-left text-center font-Nunito " dangerouslySetInnerHTML={createMarkup(t('conversionRate'))}></p>
                        </div>
                    </div>
                </div>

                <h2 className="md:text-5xl text-3xl md:w-7/12 md:mx-auto mt-12 md:mt-32 mx-10 font-bold font-Anek text-center text-gray-700" dangerouslySetInnerHTML={createMarkup(t('secondsTitle'))}></h2>
                ...
                <div className="md:w-8/12 md:my-16 p-4 flex md:flex-row flex-col gap-4 mx-auto">
                    <div className="md:w-1/2 md:border border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
                        <div className="text-center">
                            <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">{t('step1Title')}</div>
                            <p className="md:text-3xl text-2xl p-4 text-center mx-auto my-2 font-semibold font-Inter text-gray-700">{t('step1Desc')}</p>
                        </div>
                    ...
                    <div className="md:w-1/2 md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50 rounded-xl px-4 pt-6 flex flex-col md:mx-10">
                        <div className="text-center">
                            <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">{t('step2Title')}</div>
                            <p className="md:text-3xl text-2xl p-4  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">{t('step2Desc')}</p>
                        </div>
                ...
                <div className="md:w-7/12 p-6 mx-auto   rounded-xl md:border  md:border-gray-50 md:shadow-sm md:shadow-gray-50  flex md:flex-row flex-col justify-center items-center ">
                    <div className="text-center md:w-1/2 m-4">
                        <div className="text-xl w-max mx-auto text-white py-1 px-4 font-Anek font-semibold bg-indigo-400  rounded-full ">{t('step3Title')}</div>
                        <p className="md:text-3xl mt-4 text-2xl pb-2  text-center mx-auto my-2 font-semibold font-Inter text-gray-700">{t('step3Desc')}</p>
                        <p className="md:text-xl text-gray-500 text-lg">{t('step3Features')}</p>
                    </div>
                ...
                <div className="md:w-6/12 md:my-20 mb-6 mx-auto">
                    <div className="text-center m-6 px-6">
                        <p className="md:text-2xl text-xl my-2 font-semibold font-Inter text-gray-700">{t('platformSupport')}</p>
                    </div>
                ...
                <div className="bg-gray-800  text-white p-2">
                    <div className="md:w-8/12 mx-auto pt-32 p-6">
                        <h2 className="md:text-6xl text-4xl text-center font-Anek font-bold  mx-auto">{t('simpleTitle')}</h2>
                        <p className="md:text-2xl text-lg font-Inter text-gray-300 text-center py-4 md:w-8/12 mx-auto">{t('simpleDesc')}</p>
                        <Link to="/editor" >
                            <button className="flex mx-auto my-4 hover:translate-x-2 duration-300 bg-indigo-500 hover:bg-indigo-600  rounded-full  text-white md:text-xl text-base font-Nunito font-semibold p-4 px-8">{t('tryNow')}</button>
                        </Link>
                    </div>
                    ...
                    <footer className=" p-10 gap-2 flex md:flex-row flex-col-reverse font-Inter md:px-20 md:justify-between justify-center mx-auto md:w-10/12 w-full items-center">
                        <div className=" flex flex-col">
                            <span className="md:text-lg text-sm">{t('madeWith')} <a href="https://rutik.dev" className="font-semibold underline decoration-wavy underline-offset-4" target="_blank" rel="noreferrer">Rutik Wankhade</a></span>
                        </div>

                        <div className="md:text-lg text-sm flex flex-wrap gap-4 ">
                            <Link to="/faq" className="hover:underline">{t('howToUse')}</Link>
                            <a href="https://github.com/rutikwankhade/CoverView" target="_blank" rel="noreferrer" className="hover:underline">{t('github')}</a>
                            <a href="https://www.buymeacoffee.com/rutikwankhade" target="_blank" rel="noreferrer" className="hover:underline">{t('buyMeACoffee')}</a>
                        </div>
                    </footer>
                </div>
            </div>
